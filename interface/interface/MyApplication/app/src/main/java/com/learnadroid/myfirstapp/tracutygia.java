...
public class tracutygia extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isConnected()==true) {
            ...
            Toast.makeText(tracutygia.this, "Cần kết nối internet để thực hiện chức năng này", Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if(id==R.id.setting)
        {
            ...
            Bundle bundle1 = new Bundle();
            bundle1.putString("Keys",Keys);
            Intent intent = new Intent(tracutygia.this, gioithieu.class);
